...
export default function LoginPage(): JSX.Element {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (role === 'candidate') router.push('/candidate/profile');
      else if (role === 'company') router.push('/company/jobs');
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form id="login-form" onSubmit={handleSubmit((v) => mutate(v))} className="flex flex-col gap-4">
