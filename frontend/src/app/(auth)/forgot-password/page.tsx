...
export default function ForgotPasswordPage(): JSX.Element {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form id="forgot-form" onSubmit={handleSubmit((v) => mutate(v))} className="flex flex-col gap-4">
      ...
      <CardFooter className="flex flex-col gap-3">
        <Button type="submit" form="forgot-form" className="w-full" disabled={isPending}>
